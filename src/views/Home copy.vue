  ...
  <main class="home-page ">
    ...
    <!-- Hero --><!--
      ...
      <section class="default-section TheCLEARiTDifference ">
        <div class="default-containerBK" style="position: relative;padding-left:40px;">
          <div class="default-content-border-radius ho-hero-banner ">
    ...
    <section class="hero-section text-overlap__bottom">
      ...
      methodItems: [
        {
          number: '01',
          title: 'Advanced Technology',
          text: 'Faster throughput — more ink removed per session.'
        },
        {
          number: '02',
          title: 'Refined Methodology',
          text: 'Safer multi-pass protocol — less thermal stress.'
        },
        {
          number: '03',
          title: 'Managed Experience',
          text: 'Predictable planning — improved patient satisfaction.'
        }
      ],
